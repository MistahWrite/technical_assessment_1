...
let vegetables = ['celery', 'carrots', 'lettuce', "broccoli", "kale"];
...
// different fruits.
let fruits = ['tomatoes', 'bananas', 'oranges', 'apples', 'kiwi', 'pineapple', 'mango'];
...
//budget for all authors associated with a product inside items
for(var key in productsJSON.items) {
    console.log('Budget: ' + productsJSON.items[key].product.author.budget);
}
